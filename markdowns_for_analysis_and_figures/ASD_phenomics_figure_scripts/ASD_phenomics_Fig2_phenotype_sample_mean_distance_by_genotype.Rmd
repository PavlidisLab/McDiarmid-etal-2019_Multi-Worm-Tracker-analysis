...
strainsPerSides=10 # To control overplotting, we're limiting the number of labels shown to maximum 10 on each side of the wild-type.
```
...
wormData.plate.feature.mtrx <- readMatrix("data/wormData.plate.feature.mtrx")
