...
##Plot mean reversal probability for chd-7 and nlg-1.


mean_cleanrawsrev_filt <- mean_cleanrawsrev %>% 
  filter(genotype %in% c("Wild-type (N2)", "chd-7", "rme-6b1014"))
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_prob, colour = genotype)) +
  ...
  ggsave("screen_cluster_chd-7open_rme-6gray_prob.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials")
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_dur, colour = genotype)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0.5)) +
  theme(legend.position="none") 
  ggsave("screen_cluster_chd-7open_rme-6gray_dur.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials") 
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_speed, colour = genotype)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0.5)) +
  theme(legend.position="none")
  ggsave("screen_cluster_chd-7open_rme-6gray_speed.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials") 
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_dist, colour = genotype)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0.5)) +
  theme(legend.position="none") +
  ggsave("screen_cluster_chd-7open_rme-6gray_dist.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials") 


##Plot mean reversal probability for nlg-1 and bar-1. 

mean_cleanrawsrev_filt <- mean_cleanrawsrev %>% 
  filter(genotype %in% c("Wild-type (N2)", "nlg-1", "bar-1ga80"))
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_prob, colour = genotype)) +
  ...
  theme(legend.position="none") +
  theme(plot.title = element_text(face = "bold", hjust = 0.5)) 
  ggsave("screen_cluster_nlg-1open_bar-1blue_prob.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials")
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_dur, colour = genotype)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0.5)) +
  theme(legend.position="none") 
  ggsave("screen_cluster_nlg-1open_bar-1blue_dur.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials") 
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_speed, colour = genotype)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0.5)) +
  theme(legend.position="none")
  ggsave("screen_cluster_nlg-1open_bar-1blue_speed.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials") 
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_dist, colour = genotype)) + 
  ...
  theme(plot.title = element_text(face = "bold", hjust = 0.5)) +
  theme(legend.position="none") +
  ggsave("screen_cluster_nlg-1open_bar-1blue_dist.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials") 
