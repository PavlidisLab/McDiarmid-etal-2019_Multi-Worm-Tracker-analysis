...
(Only showing features significant in any direction between all alleles of the same gene)

```{r render-hm-onlysignif, echo=FALSE, fig.width=16, fig.height=21}
iheatmapper( t.stat.masked.onlysig,
             titleName= "T-test for Features (FDR < 0.1)",
             valuesNames = "T-statistic",
             useGroups = NULL,
             useClustering = "columns")

t.stat.clipped3 <- fence.matrix(t.stat.masked.onlysig, UB = 3, LB = -3, removeWT = T)
iheatmapper( t.stat.clipped3,
             titleName= "T-test for Features (FDR < 0.1, |t| < 3.0 )",
             valuesNames = "T-statistic",
             useGroups = NULL,
...
t.stat.clipped10 <- fence.matrix(t.stat.masked.onlysig, UB = 10, LB = -10, removeWT = T)
iheatmapper( t.stat.clipped10,
             titleName= "T-test for Features (FDR < 0.1, |t| < 10.0 )",
             valuesNames = "T-statistic",
             useGroups = NULL,
...
t.stat.clipped20 <- fence.matrix(t.stat.masked.onlysig, UB = 20, LB = -20, removeWT = T)
iheatmapper( t.stat.clipped20,
             titleName= "T-test for Features (FDR < 0.1, |t| < 20.0 )",
             valuesNames = "T-statistic",
             useGroups = NULL,
...
(Only showing features significant in the same direction between all alleles of the same gene)
