...
```{r render-difference-corrmatrices, echo=FALSE, fig.width=12, fig.height=9}
correlationHeatmap(t.correlation.N2 - t.correlation.mutant, zmin = -2.0, zmax=2.0, title = "Feature correlation (N2 matrix - mutant matrix)")
```
