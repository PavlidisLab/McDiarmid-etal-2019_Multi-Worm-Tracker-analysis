---
title: "Supplementary Figure Collection 3 - Phenomic Heatmaps (Only 2nd allele or outcrossed strains)."
output:
...
Phenomic heat maps summarizing the phenotypic profiles of 87 strains harbouring a mutation in an ortholog of an ASD-associated gene. Cells represent directional t-statistics from comparisons to wild-type controls. T-statistics are shown unclipped and at various clippings (t clipped at ±10, ±20, etc.).  On select indicated heat maps, only cells significant at FDR < 0.1 are colored for ease of interpretation. The heat maps are interactive allowing for more detailed inspection of selected observations. Absolute t-statics values are clipped at 3.0, 10.0 and 20.0 in the last three figures.
...
OC_2nd.allele = read.table(("user_defined_feature_labels_and_categories/2nd_allele_OC_Strain_genotype_labels_0816_2019.txt"))
