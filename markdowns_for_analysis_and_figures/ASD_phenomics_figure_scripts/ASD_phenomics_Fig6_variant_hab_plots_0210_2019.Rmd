---
title: "Figure 6 Variant Habituation"
...
setwd("/Volumes/SAMWISE/Troy/nlg_variants_0209_2019/output")
...
cleanrawsrev$genotype <- recode(cleanrawsrev$genotype, `N2` = "Wild-type (N2)", `VC228` = "nlg-1", `RM3389` = "nlg-1p::nlg-1", `RM3536` = "nlg-1 R451C", `RM3517` = "nlg-1 V397M", `RM3537` = "nlg-1 R714C", `RM3540` = "nlg-1 R62W" )
...
```{r}
##Plot of mean reversal probability for select nlg-1 missense variants

mean_cleanrawsrev_filt <- mean_cleanrawsrev %>% 
  filter(genotype %in% c("Wild-type (N2)", "nlg-1", "nlg-1 V397M"))
...
ggplot(mean_cleanrawsrev_filt, aes(stimulus_num, rev_prob, colour = genotype)) +
  ...
  ggsave("nlg-1 V397M.jpeg", width = 7, height = 6, path = "/Users/troymcdiarmid/Desktop/ASD_Screen_materials")
...
data <- read.table("/Volumes/SAMWISE/Troy/ASD_Phenomics_pub_data/nlg_variants_0209_2019/output/data.srev", sep="", header = FALSE)
...
write.table(my_tukey_summary, "/Volumes/SAMWISE/Troy/ASD_Phenomics_pub_data/nlg_variants_0209_2019/output/stats.csv")
