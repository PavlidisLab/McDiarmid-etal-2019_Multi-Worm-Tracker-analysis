...
data <- read.table("/Volumes/SAMWISE/Troy/ASD_Phenomics_pub_data/nlg1_AID_0304_2019/output/data.srev", sep="", header = FALSE)
...
my_tukey_summary <- capture.output(summary(glht_my_glm), file = NULL)
write.table(my_tukey_summary, "/Volumes/SAMWISE/Troy/ASD_Phenomics_pub_data/nlg1_AID_0304_2019/output/stats.csv")
